...
let data = fs.readFileSync("./message/zyren.js")
try{
...
exports.weton = ['Pahing', 'Pon','Wage','Kliwon','Legi'][Math.floor(((d * 1) + gmt) / 84600000) % 5]
exports.week = d.toLocaleDateString(locale, { weekday: 'long' })
exports.calender = d.toLocaleDateString(locale, {
day: 'numeric',
month: 'long',
year: 'numeric'
})
